...
WITH monthly_data AS (
    SELECT
        ...
        crash_month,
        crash_year,
        SUM(total_injuries) as mon_total_injuries,
        SUM(total_fatalities) as mon_total_fatalities,
        SUM(number_of_persons_injured) AS mon_total_persons_inj, 
        SUM(number_of_persons_killed) AS mon_total_persons_fatal,
